...
```
BASE_URL=https://www.carefirst.com BROWSER=chromium GROUP=@smoke docker-compose up --build
```
...
- `-u|--url`: The base URL used for all of the test cases. If not provided, `https://www.carefirst.com` is used.
